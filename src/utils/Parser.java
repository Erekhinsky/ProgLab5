...
import elementsOfCollection.Coordinates;
...
public class Parser {
    ...
    public static Vector<Vehicle> readArrayFromFile(InputStreamReader isr) throws IOException, ParseException, IncorrectValueException {
